...
export const metadata = {
  title: 'Solar Installation Rawalpindi | Commercial & Residential SUNORA ENERGY',
    ...
    <main className="min-h-screen bg-white pt-20">
      ...
      <section className="relative w-full h-[60vh] flex items-center justify-center overflow-hidden bg-[#0B0F0E]">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
           <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 tracking-tight">Solar Installation <span className="text-[#B8D83D]">Rawalpindi</span></h1>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-12">
             <h2 className="text-3xl font-bold text-[#0B0F0E] mb-4 border-b border-slate-100 pb-4">Reliable Power for Rawalpindi</h2>
             <p className="text-slate-600 text-lg leading-relaxed">
               Rawalpindi's dense urban layout and commercial activity demand highly efficient space-utilization for solar deployments. SUNORA ENERGY specializes in custom racking and optimized hybrid setups to ensure businesses and homes in Rawalpindi maintain power continuity and drastically reduce energy expenses.
             </p>
             
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 hover:border-[#B8D83D] transition-colors">
                   <h3 className="text-xl font-bold text-[#0B0F0E] mb-3">Hybrid Focus</h3>
                   ...
                   <Link href="/hybrid-solar-system" className="text-[#9dbf2c] font-bold hover:text-amber-600">Explore Hybrid Systems &rarr;</Link>
                </div>
                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 hover:border-[#B8D83D] transition-colors">
                   <h3 className="text-xl font-bold text-[#0B0F0E] mb-3">Commercial Installations</h3>
                   ...
                   <Link href="/get-quote" className="text-[#9dbf2c] font-bold hover:text-amber-600">Get Commercial Quote &rarr;</Link>
                </div>
             </div>
