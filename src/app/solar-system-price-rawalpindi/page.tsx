...
export const metadata: Metadata = {
  ...
  keywords: "solar system price Rawalpindi, solar panel price Rawalpindi, solar system on installments Rawalpindi",
  alternates: { canonical: '/solar-system-price-rawalpindi' },
  openGraph: {
    title: "Solar System Price in Rawalpindi | Quotes & Installments",
    description: "Request current quotes for solar system prices in Rawalpindi. We assess your requirements for 5kW, 10kW, hybrid setups, and offer cash/installment options.",
    ...
    <div className="w-full flex flex-col bg-zinc-50">
      ...
      <section className="w-full bg-zinc-950 py-24 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          <Breadcrumbs items={[{ label: 'Solar System Price in Rawalpindi', href: '/solar-system-price-rawalpindi' }]} />
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6">Solar System Price in Rawalpindi</h1>
      ...
      <section className="w-full py-20 px-4 sm:px-6 lg:px-8 bg-zinc-50 border-y border-zinc-100">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-zinc-900 mb-10 text-center">System Configurations in Rawalpindi</h2>
      ...
      <section className="w-full py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="border-l-4 border-zinc-900 pl-6">
            ...
            <p className="text-zinc-600 leading-relaxed">Customers can request a quotation for upfront purchase. The quoted cash price is based on the finalized hardware and installation requirements for your Rawalpindi property.</p>
          </div>
      ...
      <section id="quote" className="w-full py-20 px-4 sm:px-6 lg:px-8 bg-zinc-900 text-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold mb-4">Request Your Rawalpindi Quote</h2>
      ...
      <section className="w-full py-8 px-4 sm:px-6 lg:px-8 bg-zinc-950 border-t border-zinc-900">
        <div className="max-w-6xl mx-auto flex flex-wrap justify-center gap-6 text-sm">
          <Link href="/solar-installation-rawalpindi" className="text-zinc-400 hover:text-white transition">Solar Installation Rawalpindi</Link>
