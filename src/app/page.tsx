...
export const metadata: Metadata = {
  title: "Solar Installation Islamabad & Rawalpindi | [Business Name]",
  ...
  return (
    <div className="w-full flex flex-col bg-white">
      ...
      <section className="relative w-full bg-zinc-950 py-24 md:py-32 px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-emerald-900 via-zinc-950 to-zinc-950"></div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center">
          ...
          <div className="mt-8 text-zinc-400 font-medium">
            Or call us directly at <a href="tel:[PHONE_NUMBER]" className="text-white hover:text-emerald-400 transition">[PHONE_NUMBER]</a>
          </div>
        </div>
      </section>
      ...
      <section className="w-full py-24 px-4 sm:px-6 lg:px-8 bg-zinc-950 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto">
            ...
            <a href="https://wa.me/[WHATSAPP_NUMBER]" target="_blank" rel="noopener noreferrer" className="border border-zinc-600 text-white font-bold px-8 py-4 rounded-md hover:bg-zinc-800 transition text-lg w-full sm:w-auto flex items-center justify-center gap-2">
              Chat on WhatsApp
            </a>
          </div>
        </div>
