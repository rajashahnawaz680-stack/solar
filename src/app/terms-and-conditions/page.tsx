...
export const metadata: Metadata = {
  ...
  description: 'Learn more about Terms And Conditions and get the best solar solutions in Islamabad and Rawalpindi.',
};

export default function Page() {
  return (
    <main className="min-h-[60vh] py-20 px-6 md:px-12 flex flex-col items-center justify-center bg-zinc-50">
      <h1 className="text-4xl font-bold mb-4 text-zinc-900 text-center">Terms And Conditions</h1>
      <p className="text-lg text-zinc-600 text-center max-w-2xl mb-8">
        This is a placeholder page for Terms And Conditions. Detailed content, pricing, and options will be added here soon.
      </p>
