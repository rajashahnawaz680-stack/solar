...
export default function FinalCTA() {
  return (
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative h-[500px] md:h-[600px] w-full flex items-center justify-center">
         ...
         <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
               <Link href="/get-quote" className="w-full sm:w-auto bg-[#B8D83D] text-[#0B0F0E] font-extrabold px-10 py-5 rounded-xl hover:bg-[#9dbf2c] transition-colors shadow-2xl text-lg transform hover:-translate-y-1">
      ...
      {/* Trust Strip */}
      <div className="bg-black border-t border-[#183C32]">
         <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="flex flex-wrap justify-center md:justify-between items-center gap-6 text-sm font-bold uppercase tracking-wider text-slate-400">
               <div className="flex items-center">
                 <svg className="w-5 h-5 text-[#9dbf2c] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.243-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                 Islamabad & Rawalpindi
               </div>
               <div className="hidden md:block w-px h-6 bg-[#183C32]"></div>
               <div className="flex items-center">
                 <svg className="w-5 h-5 text-[#9dbf2c] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
               ...
               <div className="hidden md:block w-px h-6 bg-[#183C32]"></div>
               <div className="flex items-center">
                 <svg className="w-5 h-5 text-[#9dbf2c] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
