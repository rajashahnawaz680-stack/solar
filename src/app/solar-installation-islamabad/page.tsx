...
export const metadata = {
  title: 'Solar Installation Islamabad | Residential & Commercial Solar KCKY',
    ...
    <main className="min-h-screen bg-white pt-20">
      ...
      <section className="relative w-full h-[60vh] flex items-center justify-center overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
           <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6 tracking-tight">Solar Installation <span className="text-amber-400">Islamabad</span></h1>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-12">
             <h2 className="text-3xl font-bold text-slate-900 mb-4 border-b border-slate-100 pb-4">Capitalizing on Islamabad's Solar Potential</h2>
             <p className="text-slate-600 text-lg leading-relaxed">
               Islamabad enjoys excellent year-round sun exposure, making it highly lucrative for both residential and commercial solar deployments. Whether you are in DHA, Bahria Town, or the central G and F sectors, Solar KCKY provides robust on-grid and hybrid architectures to slash your monthly utility bills.
             </p>
             
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                   <h3 className="text-xl font-bold text-slate-900 mb-3">Residential Solar</h3>
                   ...
                   <Link href="/5kw-solar-system" className="text-amber-500 font-bold hover:text-amber-600">View 5kW Option &rarr;</Link>
                </div>
                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                   <h3 className="text-xl font-bold text-slate-900 mb-3">Commercial Solar</h3>
                   ...
                   <Link href="/15kw-solar-system" className="text-amber-500 font-bold hover:text-amber-600">View Commercial Options &rarr;</Link>
                </div>
             </div>
