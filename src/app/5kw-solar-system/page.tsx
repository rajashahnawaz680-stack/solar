  ...
  return (
    <main className="min-h-screen bg-white pt-20">
      ...
      <section className="relative w-full h-[60vh] flex items-center justify-center overflow-hidden bg-slate-900">
        <img src="https://images.unsplash.com/photo-1613665813446-82a78c468a1d?auto=format&fit=crop&w=1920&q=80" alt="Modern residential rooftop solar 5kw" className="absolute inset-0 w-full h-full object-cover opacity-40 mix-blend-overlay" />
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
           ...
           <div className="flex items-center justify-center space-x-2 text-sm text-slate-300 mb-6 font-medium">
             ...
             <span>/</span>
             <span className="text-amber-400">5kW System</span>
           </div>
          ...
          <div className="lg:col-span-2 space-y-20">
            ...
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                Our 5kW solar solutions are meticulously engineered to provide maximum efficiency and reliability for properties across the twin cities. By utilizing verified, industry-standard equipment, we ensure robust energy independence.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                 ...
                 <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 flex items-start shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 leading-relaxed">Perfect for smaller residential properties looking to offset basic daily appliance consumption.</p>
                    </div>
                 </div>
                 <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 flex items-start shadow-sm hover:shadow-md transition-shadow">
                    <div className="w-12 h-12 bg-slate-900 text-amber-400 rounded-lg flex items-center justify-center mr-4 shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 leading-relaxed">Highly cost-effective with excellent ROI for standard usage profiles.</p>
                    </div>
                 </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                 <details className="group bg-slate-50 rounded-2xl border border-slate-200 cursor-pointer">
                    ...
                    <p className="text-slate-600 px-6 pb-6 leading-relaxed">
                       Yes, where applicable and supported by the local grid, net metering processing can be handled alongside your 5kW installation to maximize ROI.
                    </p>
                 </details>
                 <details className="group bg-slate-50 rounded-2xl border border-slate-200 cursor-pointer">
                    <summary className="flex justify-between items-center font-bold text-lg text-slate-900 p-6 list-none">
