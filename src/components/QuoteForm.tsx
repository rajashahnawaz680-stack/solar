    ...
    return (
      <div className="bg-white p-10 rounded-xl shadow-lg border border-emerald-100 flex flex-col items-center text-center max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <a href="https://wa.me/[WHATSAPP_NUMBER]" className="bg-emerald-600 text-white font-bold px-8 py-4 rounded-md hover:bg-emerald-700 transition flex items-center justify-center gap-2">
      ...
      {isError && (
        <div className="bg-red-50 text-red-700 p-6 rounded-md mb-8 flex flex-col items-center text-center">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://wa.me/[WHATSAPP_NUMBER]" className="bg-zinc-900 text-white font-bold px-6 py-2 rounded-md hover:bg-zinc-800 transition">
              Chat on WhatsApp
            </a>
          </div>
        </div>
