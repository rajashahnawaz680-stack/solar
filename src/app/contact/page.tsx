    ...
    <div className="w-full flex flex-col bg-zinc-50">
      ...
      <section className="w-full py-16 px-4 sm:px-6 lg:px-8 -mt-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          <a href="https://wa.me/03125634911?text=Hello,%20I%20would%20like%20information%20about%20solar%20installation%20in%20Islamabad/Rawalpindi." target="_blank" rel="noopener noreferrer" className="bg-white p-8 rounded-xl shadow-md border border-zinc-100 flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
            ...
            <p className="text-zinc-600">03125634911</p>
          </a>
          <a href="tel:03125634911" className="bg-white p-8 rounded-xl shadow-md border border-zinc-100 flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
          ...
          <a href="mailto:rajashahawaz680@gmail.com" className="bg-white p-8 rounded-xl shadow-md border border-zinc-100 flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
            <div className="w-14 h-14 bg-zinc-100 text-zinc-700 rounded-full flex items-center justify-center mb-4">
            ...
            <p className="text-zinc-600">rajashahawaz680@gmail.com</p>
          </a>
        </div>
      </section>
