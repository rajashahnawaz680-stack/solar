...
export const metadata = {
  ...
  description: 'High-capacity system for large homes or small commercial spaces.'
};
  ...
  return (
    <main className="min-h-screen bg-white pt-20">
      ...
      <section className="relative w-full h-[60vh] flex items-center justify-center overflow-hidden bg-slate-900">
        <img src="https://images.unsplash.com/photo-1592833159155-c62df1b65634?auto=format&fit=crop&w=1920&q=80" alt="10kW Solar System" className="absolute inset-0 w-full h-full object-cover opacity-40 mix-blend-overlay" />
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
           ...
           <p className="text-xl md:text-2xl text-slate-300 mb-10 drop-shadow-md">High-capacity system for large homes or small commercial spaces.</p>
          ...
          <div className="lg:col-span-2 space-y-16">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                Our 10kw solar system services are engineered to provide maximum efficiency and reliability for properties in Islamabad and Rawalpindi. We utilize verified, industry-standard equipment to ensure long-term performance and robust energy independence.
              </p>
            </div>
              ...
              <div className="space-y-6">
                 <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">We analyze your energy consumption and property structure to design the optimal 10kw solar system.</p>
                    </div>
                 </div>
                 <div className="flex">
