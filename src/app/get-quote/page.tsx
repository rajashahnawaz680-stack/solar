...
export const metadata: Metadata = {
  title: "Get a Free Solar Quote in Islamabad & Rawalpindi | Solar KCKY",
          ...
          <div className="w-full lg:w-1/3 flex flex-col gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-zinc-100 mt-0 lg:mt-6">
              ...
              <div className="space-y-4">
                <a href="https://wa.me/03125634911" className="flex items-center gap-4 text-zinc-700 hover:text-emerald-600 transition">
                ...
                <a href="tel:03125634911" className="flex items-center gap-4 text-zinc-700 hover:text-emerald-600 transition">
                  <div className="w-10 h-10 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm">03125634911</div>
                  </div>
                </a>
                <a href="mailto:rajashahawaz680@gmail.com" className="flex items-center gap-4 text-zinc-700 hover:text-emerald-600 transition">
                  <div className="w-10 h-10 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                  </div>
                  <div>
                    <div className="font-semibold text-zinc-900">Email</div>
                    <div className="text-sm">rajashahawaz680@gmail.com</div>
                  </div>
                </a>
              </div>
            </div>
