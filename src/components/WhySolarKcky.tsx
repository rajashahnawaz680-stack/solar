      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative h-[600px] rounded-3xl overflow-hidden shadow-2xl group">
             ...
             <div className="absolute bottom-8 left-8 bg-white/90 backdrop-blur-sm p-4 rounded-2xl shadow-xl flex items-center">
                <div className="w-12 h-12 bg-amber-400 rounded-full flex items-center justify-center mr-4">
                   <svg className="w-6 h-6 text-slate-900" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                </div>
                <div>
                  <span className="block font-extrabold text-slate-900 text-lg">Solar KCKY</span>
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-lg text-slate-600 mb-10 leading-relaxed border-l-4 border-amber-400 pl-6">
            ...
            <div className="space-y-6 mb-12">
               <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 text-lg">Residential & Commercial Solutions</h4>
                  </div>
               </div>
               <div className="flex items-start">
                  <div className="w-10 h-10 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-center shrink-0 mr-4 mt-1">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 text-lg">Islamabad & Rawalpindi Service</h4>
                  </div>
               </div>
               <div className="flex items-start">
                  <div className="w-10 h-10 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-center shrink-0 mr-4 mt-1">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 text-lg">Multiple Solar System Options</h4>
                  </div>
               </div>
               <div className="flex items-start">
                  <div className="w-10 h-10 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-center shrink-0 mr-4 mt-1">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 text-lg">Professional Installation & Support</h4>
                  </div>
               </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <Link href="/contact" className="w-full sm:w-auto bg-slate-900 text-white font-bold px-8 py-4 rounded-xl hover:bg-slate-800 transition-colors shadow-lg text-center">
                Talk to Solar KCKY &rarr;
              </Link>
              <Link href="/projects" className="w-full sm:w-auto bg-slate-50 text-slate-900 border border-slate-200 font-bold px-8 py-4 rounded-xl hover:bg-slate-100 transition-colors text-center">
