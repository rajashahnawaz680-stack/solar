...
export const metadata = {
  title: 'Hybrid Solar — Solar Panel Rawalpindi & Islamabad',
  description: 'Solar generation with battery backup — ideal for load shedding areas.',
};
  ...
  return (
    <main className="min-h-screen bg-[#F5F6F1]">
      <section className="relative bg-[#0B0F0E] pt-24 overflow-hidden min-h-[500px] flex items-end">
        <img src="https://images.unsplash.com/photo-1592833159155-c62df1b65634?auto=format&fit=crop&w=1200&q=80" alt="Hybrid Solar" className="absolute inset-0 w-full h-full object-cover opacity-40 mix-blend-overlay" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 pb-20 text-center w-full">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6">Hybrid Solar</h1>
          <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">Solar generation with battery backup — ideal for load shedding areas.</p>
      ...
      <section className="max-w-5xl mx-auto px-4 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed text-lg mb-8">A hybrid system combines rooftop solar with battery backup so you can reduce costs while maintaining power during outages.</p>
